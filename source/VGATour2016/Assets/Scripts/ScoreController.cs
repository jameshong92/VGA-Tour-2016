...
//		players.Add(player5);
		...
		showScoreboard = !transform.parent.parent.parent.name.Contains ("Temp");
		UpdateScores ();
	}
	
	// Update is called once per frame
	void Update () {
		// if showing scoreboard
		//if (!showScoreboard && !transform.parent.parent.parent.name.Contains ("Temp")) {
		UpdateScores();
		//}
		//showScoreboard = !transform.parent.parent.parent.name.Contains ("Temp");
	...
	void UpdateScores() {
		...
		players = new List<Player> (GlobalData.players);
